...
// for the screen 2 button(s) (i.e. switching screen), we have a standard 
// size of 40 pixels
int s2_button_size = 40;

// CODE

// set up function for screen 2
void screen_2_setup()
{
  ...
  screen_1_button.initButton(&tft, 
                             ...
                             screen_1_button_sz, s2_button_size, 
  ...
  screen_2_button.initButton(&tft, 
                             ...
                             screen_2_button_sz, s2_button_size, 
...
// loop function for screen 2 for touch screen
void screen_2_loop_ts()
{
  ...
  if (ts.touched())
  {
    ...
    if (screen_1_button.contains(x, y))
    {
      screen_1_button.press(true);
    }
  }
  // as soon as it's released, reset both the button presses
  else
  {
    screen_1_button.press(false);    
  }

  // switch screens

  // control screen button
  if (screen_1_button.justPressed())
  {
    screen_idx = 1;
